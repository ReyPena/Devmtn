...
*/
  ...
  function removeItem(myGroceryList, itemToRemove) {
    ...
    if (item === -1){
        myGroceryList.splice(item, 1, itemToRemove);
      }
    return myGroceryList;
  }
  function addItem(myGroceryList, itemToAdd) {
    var item = myGroceryList.indexOf(itemToAdd);
    if (item === 1){
...
/*Above you're given an empty array with four objects. Fill the devMountainEmployees array with those four objects. After that console.log the length of the Array and make
...
/*Now we're going to combine what we've learned today (objects) with what we learned yesterday (arrays). Yeah, take a deep breathe. You're ready for this, promise.
