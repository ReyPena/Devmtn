...
app.controller('mainCtrl', ['$scope', 'parseService', function($scope, parseService){
...
// this is the user name prompt that ask for the name and save it

  parseService.userName = prompt("User Name");
